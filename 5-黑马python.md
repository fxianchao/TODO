- [黑马python](#黑马python)
  ...
  - [~~>>>17-flask项目-爱家租房{19-4-12}~~](#17-flask项目-爱家租房19-4-12)
    ...
    - [19-4-12](#19-4-12)
      ...
      - [项目优化](#项目优化)
        ...
        - [数据库优化](#数据库优化)
          - [工作流程](#工作流程)
  - [~~>>>18|19|20-通用爬虫模块|Mongo数据库|Scrapy框架{19-5-26}~~](#181920-通用爬虫模块Mongo数据库Scrapy框架19-5-26)
    - [19-4-14](#19-4-14)
      - [爬虫基本概念](#爬虫基本概念)
        - [课程介绍和概念](#课程介绍和概念)
        - [爬虫的分类](#爬虫的分类)
  ...
  - [~~>>>21-数据分析{19-6-25}~~](#21-数据分析19-6-25)
    - [19-5-30](#19-5-30)
      - [数据分析介绍](#数据分析介绍)
      - [环境安装](#环境安装)
    - [19-6-1](#19-6-1)
...
## ~~>>>18|19|20-通用爬虫模块|Mongo数据库|Scrapy框架{19-5-26}~~
...
3. 把分开的时间字符串转化为pandas中的时间类型`period = pd.PeriodIndex(year=df["year"],month=df["month"],day=df["day"],hour=df["hour"],freq="H")`
