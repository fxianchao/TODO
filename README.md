...
9. 配置虚拟主机文件
   1. 新建文件`/home/ubuntu/nginx_config/nginx_demo_1`.
    ...
    1. 建立软连接`sudo ln -s /home/ubuntu/nginx_config/nginx_demo_1  /etc/nginx/sites-enabled/`,nginx配置文件会自动读取内容.
    2. 重启nginxf服务`sudo systemctl reload nginx.service`.
